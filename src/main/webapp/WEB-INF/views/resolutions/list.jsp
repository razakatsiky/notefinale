...
<body>
    ...
    <div class="container">
        ...
        <a href="/resolutions/new" class="btn btn-success">Ajouter une Résolution</a>
            ...
            <tbody>
                <c:forEach items="${resolutions}" var="resolution">
                    <tr>
                        ...
                        <td class="actions">
                            <a href="/resolutions/edit/${resolution.id}" class="btn">Modifier</a>
                            <a href="/resolutions/delete/${resolution.id}" class="btn btn-danger" 
