...
<head>
    ...
    <title>${resolution.id == null ? 'Ajouter' : 'Modifier'} une Résolution</title>
    <style>
...
<body>
    <div class="header">
        <h1>${resolution.id == null ? 'Ajouter' : 'Modifier'} une Résolution</h1>
    </div>
    ...
    <div class="container">
        ...
        <form action="${resolution.id == null ? '/resolutions' : '/resolutions'}" method="post">
            <c:if test="${resolution.id != null}">
            ...
            <button type="submit" class="btn">
                ${resolution.id == null ? 'Ajouter' : 'Modifier'}
            </button>
            <a href="/resolutions" class="btn btn-danger">Annuler</a>
        </form>
