...
<head>
    ...
    <title>Système de Calcul de Notes Finales</title>
    <style>
...
<body>
    ...
    <div style="text-align: center; margin-top: 30px;">
        <a href="/calculer-note" class="nav-button" style="display: inline-block; padding: 10px 20px; border: 1px solid black;">Calculer une Note Finale</a>
    </div>
</body>
</html>
