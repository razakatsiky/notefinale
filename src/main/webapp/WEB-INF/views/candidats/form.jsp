...
<head>
    ...
    <title>${candidat.id == null ? 'Ajouter' : 'Modifier'} un Candidat</title>
    <style>
...
<body>
    <div class="header">
        <h1>${candidat.id == null ? 'Ajouter' : 'Modifier'} un Candidat</h1>
    </div>
    ...
    <div class="container">
        ...
        <form action="${candidat.id == null ? '/candidats' : '/candidats'}" method="post">
            <c:if test="${candidat.id != null}">
                <input type="hidden" name="id" value="${candidat.id}">
            </c:if>
            
            <div class="form-group">
                <label for="nom">Nom du Candidat:</label>
                <input type="text" id="nom" name="nom" value="${candidat.nom}" required>
            </div>
            
            <button type="submit" class="btn">
                ${candidat.id == null ? 'Ajouter' : 'Modifier'}
            </button>
            <a href="/candidats" class="btn btn-danger">Annuler</a>
        </form>
