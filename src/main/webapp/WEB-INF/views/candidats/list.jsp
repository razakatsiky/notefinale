...
<body>
    ...
    <div class="container">
        ...
        <a href="/candidats/new" class="btn btn-success">Ajouter un Candidat</a>
            ...
            <tbody>
                <c:forEach items="${candidats}" var="candidat">
                    <tr>
                        ...
                        <td>${candidat.nom}</td>
                        <td class="actions">
                            <a href="/candidats/edit/${candidat.id}" class="btn">Modifier</a>
                            <a href="/candidats/delete/${candidat.id}" class="btn btn-danger" 
