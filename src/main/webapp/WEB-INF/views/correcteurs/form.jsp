...
<head>
    ...
    <title>${correcteur.id == null ? 'Ajouter' : 'Modifier'} un Correcteur</title>
    <style>
...
<body>
    <div class="header">
        <h1>${correcteur.id == null ? 'Ajouter' : 'Modifier'} un Correcteur</h1>
    </div>
    ...
    <div class="container">
        ...
        <form action="${correcteur.id == null ? '/correcteurs' : '/correcteurs'}" method="post">
            <c:if test="${correcteur.id != null}">
                <input type="hidden" name="id" value="${correcteur.id}">
            </c:if>
            
            <div class="form-group">
                <label for="nom">Nom du Correcteur:</label>
                <input type="text" id="nom" name="nom" value="${correcteur.nom}" required>
            </div>
            
            <button type="submit" class="btn">
                ${correcteur.id == null ? 'Ajouter' : 'Modifier'}
            </button>
            <a href="/correcteurs" class="btn btn-danger">Annuler</a>
        </form>
