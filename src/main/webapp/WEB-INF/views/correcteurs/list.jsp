...
<body>
    ...
    <div class="container">
        ...
        <a href="/correcteurs/new" class="btn btn-success">Ajouter un Correcteur</a>
            ...
            <tbody>
                <c:forEach items="${correcteurs}" var="correcteur">
                    <tr>
                        ...
                        <td class="actions">
                            <a href="/correcteurs/edit/${correcteur.id}" class="btn">Modifier</a>
                            <a href="/correcteurs/delete/${correcteur.id}" class="btn btn-danger" 
