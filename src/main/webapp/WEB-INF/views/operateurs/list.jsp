...
<body>
    ...
    <div class="container">
        ...
        <a href="/operateurs/new" class="btn btn-success">Ajouter un Opérateur</a>
            ...
            <tbody>
                <c:forEach items="${operateurs}" var="operateur">
                    <tr>
                        ...
                        <td class="actions">
                            <a href="/operateurs/edit/${operateur.id}" class="btn">Modifier</a>
                            <a href="/operateurs/delete/${operateur.id}" class="btn btn-danger" 
