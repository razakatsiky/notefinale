...
<body>
    ...
    <div class="container">
        ...
        <a href="/matieres/new" class="btn btn-success">Ajouter une Matière</a>
            ...
            <tbody>
                <c:forEach items="${matieres}" var="matiere">
                    <tr>
                        ...
                        <td>${matiere.nom}</td>
                        <td class="actions">
                            <a href="/matieres/edit/${matiere.id}" class="btn">Modifier</a>
                            <a href="/matieres/delete/${matiere.id}" class="btn btn-danger" 
