...
<head>
    ...
    <title>${matiere.id == null ? 'Ajouter' : 'Modifier'} une Matière</title>
    <style>
...
<body>
    <div class="header">
        <h1>${matiere.id == null ? 'Ajouter' : 'Modifier'} une Matière</h1>
    </div>
    ...
    <div class="container">
        ...
        <form action="${matiere.id == null ? '/matieres' : '/matieres'}" method="post">
            ...
            <button type="submit" class="btn">
                ${matiere.id == null ? 'Ajouter' : 'Modifier'}
            </button>
            <a href="/matieres" class="btn btn-danger">Annuler</a>
        </form>
