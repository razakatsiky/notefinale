...
<body>
    ...
    <div class="container">
        ...
        <a href="/parametres/new" class="btn btn-success">Ajouter un Paramètre</a>
            ...
            <tbody>
                <c:forEach items="${parametres}" var="parametre">
                    <tr>
                        ...
                        <td>${parametre.operateur.operateur}</td>
                        <td>${parametre.resolution.nom}</td>
                        <td>${parametre.difference}</td>
                        <td class="actions">
                            <a href="/parametres/edit/${parametre.id}" class="btn">Modifier</a>
                            <a href="/parametres/delete/${parametre.id}" class="btn btn-danger" 
